...
import { DeleteIcon, EditIcon, SearchListIcon } from "@shopify/polaris-icons";
                ...
                <InlineStack gap="300" wrap={false}>
                  ...
                  <div style={{ minWidth: "120px" }}>
                    <Select
                      ...
                      value={vehicleType}
                      onChange={(selected) =>
                        setVehicleType(selected as "2-wheeler" | "4-wheeler")
                      }
